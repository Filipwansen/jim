...
$tab_43322adr5ww = mysqli_fetch_object($result103322adr5ww);
 ...
 -->
                 ...
                 <div class="row">
                             ...
                             <label style="margin-left:15px;">Program Director</label> 
...
$tab_43322adr5wwee = mysqli_fetch_object($result103322adr5wwee);
                 ...
                 <div class="row">
                          ...
                          <label style="margin-left:15px;">Medical Director</label>
                 ...
                 <div class="row">
                           ...
                           <label style="margin-left:15px;">Assistant Program Director</label>
                ...
                <div id="tab-5" class="tab-content <?php if($current == 'current5') { echo 'current'; }; ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                              ...
                              <label style="margin-left: 15px;">Current CAA Employer </label> 
                    ...
                    <form id="GeneralInfo_Form" name="GeneralInfo_Form"  action="process/tab1.php?tab=current7" enctype="multipart/form-data" method="POST">
                     ...
                     <div class="row">
                         ...
                         <div class="col12">
                             ...
                             <span class="radio-row"><input data-validation="required" onchange="" type="radio" class="radiobox" <?php if($employer_compensation->full_compension == '$161,000 - $179,000'){ echo "Checked";} ?> name="full_compension" value="$161,000 - $179,000" id="Answer19">$161,000 - $179,000</span>



                             <span class="radio-row"><input data-validation="required" onchange="" type="radio" class="radiobox" <?php if($employer_compensation->full_compension == '$180,000 - $200,000'){ echo "Checked";} ?> name="full_compension" value="$180,000 - $200,000" id="Answer19">$180,000 - $200,000</span>



                             <span class="radio-row"><input data-validation="required" onchange="" type="radio" class="radiobox" <?php if($employer_compensation->full_compension == '$200,000 - $225,000'){ echo "Checked";} ?> name="full_compension" value="$200,000 - $225,000" id="Answer19">$200,000 - $225,000</span>



                             <span class="radio-row"><input data-validation="required" onchange="" type="radio" class="radiobox" <?php if($employer_compensation->full_compension == 'Over $226,000'){ echo "Checked";} ?> name="full_compension" value="Over $226,000" id="Answer19">Over $226,000</span>
                 ...
                 <div class="submit-row">
                    ...
                    <div class="row">
                         ...
                         <div class="col12" >
                             ...
                             <span><input  type="radio"  <?php if($other_memberships->belong_to_othermembership == "Yes"){ echo "checked";} ?> name="belong_to_othermembership" value="Yes" onclick="show2(); ">Yes</span>



                            <span><input  type="radio" <?php if($other_memberships->belong_to_othermembership == "No"){ echo "checked";} ?> name="belong_to_othermembership" value="No" onclick="show1();">No</span>
                        ...
                        <div class="row hide" style="margin-left:0px;" id="div1">
                         ...
                         <div class="col6 ">
                             ...
                             <select  class="form-input" onchange="" id="national"  name="national">
                               ...
                               <option  value="AAAA">American Academy of Anesthesiologist Assistants</option>
                         ...
                         <div class="col6" >
                             ...
                             <label>State Level - Academy of Anesthesiologist Assistants </label>
                             ...
                             <select  class="form-input" onchange="" id="national"  name="national">
						           ...
						           <option  value="AlabamaAAA">AlabamaAAA</option>

						           <option  value="ColoradoAAA">ColoradoAAA</option>

						           <option  value="DCAAA">DCAAA</option>

						           <option  value="FloridaAAA">FloridaAAA</option>

						           <option  value="GeorgiaAAA">GeorgiaAAA</option>

						           <option  value="IndianaAAA">IndianaAAA</option>

						           <option  value="KentuckyAAA">KentuckyAAA</option>

						           <option  value="MichiganAAA">MichiganAAA</option>

						           <option  value="MissouriAAA">MissouriAAA</option>

						           <option  value="New MexicoAAA">New MexicoAAA</option>

						           <option  value="North CarolinaAAA">North CarolinaAAA</option>

						           <option  value="OhioAAA">OhioAAA</option>

						           <option  value="OklahomaAAA">OklahomaAAA</option>

						           <option  value="South CarolinaAAA">South CarolinaAAA</option>

						           <option  value="TexasAAA">TexasAAA</option>

						           <option  value="VermontAAA">VermontAAA</option>

						           <option  value="WisconsinAAA">WisconsinAAA</option>
                         ...
                         <div class="col6 " >
                             ...
                             <select  class="form-input" onchange="" id="national"  name="national">
                               ...
                               <option  value="ASA">American Society of Anesthesiologists</option>
                         ...
                         <div class="col6" >
                             ...
                             <label>State Level - Society of Anesthesiologists</label>
...
<script type="text/javascript">
 ...
 {  
    ...
    var general_info_form_field2_p = '<?php echo $row_general_info->m_name; ?>';
 	...
 	var general_info_form_field3_p = '<?php echo $row_general_info->l_name; ?>';
    ...
    var alma_university_p = '<?php echo $rowState->id ?>';
    ...
    if(general_info_form_field0_p!=general_info_form_field0_n)
    ...
    if(general_info_form_field4_p!=general_info_form_field4_n)
    ...
    if(program_university_18_p!=program_university_18_n)
...

{
  ...
  var check2=0;
    ...
    var personal_form_info1_p = '<?php echo $personal_information->gender ?>';

 	var personal_form_info1_n = $('#personal_form_info1').find(":selected").text(); 

 	if(personal_form_info1_p!=personal_form_info1_n)
    ...
    var personal_form_info2_p = '<?php echo $personal_information->race ?>';
 	...
 	if(personal_form_info2_p!=personal_form_info2_n)
    ...
    var ethnicity_id_p = '<?php echo $personal_information->ethnicity ?>';
 	...
 	if(ethnicity_id_p!=ethnicity_id_n)
    ...
    var general_info_form_field5_p = '<?php echo $personal_information->marital_status ?>';
 	...
 	if(general_info_form_field5_p!=general_info_form_field5_n)
