                      <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="help" role="tabpanel" aria-labelledby="help-tab">
							...
							<div class="row align-items-center mb-3"><div class="col-sm-6"><a href="?content=content/cdqhistory">< Back</a></div><div class="col-sm-6 text-right"><button type="button" class="btn" id="cdq_first_pay">Pay Now</button></div><div class="clearfix"></div></div>
