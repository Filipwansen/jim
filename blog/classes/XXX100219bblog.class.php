                                                    ...
                                                    <div class="blog-main-container">
														<div class="row">
															...
															<div class="col-12" style="margin-top:15px;">	
																<h1 class="blog-title" style="font-size:24px;"> {$title} </h1>
															</div>
														</div>
...
EOD;
					foreach ($results as $rec) {
						...
						$contents2 = str_replace('<p>', '', $contents1);
						$contents = str_replace('</p>', '<br>', $contents2);
						$outputHTML .=<<<EOD
                                                        ...
                                                        <div class="blog-content con">
                                                            <a href="?content=blog/template/viewarticle&id={$post_id}" style="font-size:22px;"> {$title} </a>
                                                            <div class="row">
                                                                <div class="col-12 more">{$contents}</div>                              
                                                            </div>
                                                        </div>
...
EOD;
					...
					$outputHTML .=<<<EOD
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-xs-12">
                                                                <div class="pagination">
                                                                    <a href="?content=blog/template/blogviewall&page=1"><button style='height:27px;'><i class="fa fa-step-backward" aria-hidden="true"></i></button></a>&nbsp;
EOD;
                                                                    ...
                                                                    for ($x=$initial_num; $x<$condition_limit_num; $x++) {
                                                                        ...
                                                                        if (($x > 0) && ($x <= $total_pages)) {    
                                                                            // current page
                                                                            if ($x == $page) {
                                                                                $outputHTML .= "<a class='active' href=\"#\"><button class='btn-primary' style='height:27px;'>$x </button><span class=\"sr-only\">(current)</span></a>&nbsp;";
                                                                            } 
                                                                            // not current page
                                                                            else {
                                                                                $outputHTML .= "<a href='?content=blog/template/blogviewall&page=$x'><button style='height:27px;'>$x</button></a>&nbsp;";
                                                                            }
                                                                        }
                                                                    }
					...
					$outputHTML .=<<<EOD
                                                                    <a href="?content=blog/template/blogviewall&page={$total_pages}"><button style="height:27px;"><i class="fa fa-step-forward" aria-hidden="true"></i></button></a>
                                                                </div>
                                                            </div>
                                                        </div>                                                
                                                    </div>
