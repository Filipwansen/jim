						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="col-md-4">
									...
									<a href="?content=content/exams" class="btn select_exams" id="select_cdq" align="center">CDQs</a>
									
								</div>
								
								<div class="col-md-4">
								
									<a href="?content=content/certification" class="btn select_exams" id="select_certification"  style="background: rgb(36,96,139); color: white;">Certification</a>
						...
						<div class="row" style="margin-top:20px">
							...
							<div class="col-md-12">
								...
								<div class="col-md-2">
									...
									<a href="?content=content/certification&select_exam_date=21">Feb. 6, <?php echo ($select_exam_date['year'] + 1);?></a>
								
								</div>
								
								<div class="col-md-2">
								
									<a href="?content=content/certification&select_exam_date=61">June. 1, <?php echo ($select_exam_date['year'] + 1);?></a>
								
								</div>
								
								<div class="col-md-2">
								
									<a href="?content=content/certification&select_exam_date=22">Feb. 7, <?php echo ($select_exam_date['year'] + 2);?></a>
								
								</div>
								
								<div class="col-md-2">
								
									<a href="?content=content/certification&select_exam_date=62">June. 2, <?php echo ($select_exam_date['year'] + 2);?></a>
								
								</div>
								
								<div class="col-md-2">
								
									<a href="?content=content/certification&select_exam_date=23">Feb. 4, <?php echo ($select_exam_date['year'] + 3);?></a>
                    ...
                    <table id="memberTable" class="table stable table-striped table-bordered nowrap" style="width:100%; text-align:center; font-size:14px !important">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo ($certification->readActionExamMon($rec[0]['exam_mon']).".1. ".$rec[0]['exam_year']);?></td>
