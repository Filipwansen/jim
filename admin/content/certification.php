						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="col-md-4">
									...
									<a href="?content=content/cmes&li_class=Exams" class="btn select_exams" id="select_cme">CMEs</a>
						...
						<div class="row" style="margin-top:20px">
							...
							<div class="col-md-12">
								...
								<div class="col-md-2">
									...
									<a href="?content=content/certification&li_class=Exams&select_exam_date=21">Feb. 6, <?php echo ($select_exam_date['year'] + 1);?></a>
								
								</div>
								
								<div class="col-md-2">
								
									<a href="?content=content/certification&li_class=Exams&select_exam_date=61">June. 1, <?php echo ($select_exam_date['year'] + 1);?></a>
								
								</div>
								
								<div class="col-md-2">
								
									<a href="?content=content/certification&li_class=Exams&select_exam_date=22">Feb. 7, <?php echo ($select_exam_date['year'] + 2);?></a>
								
								</div>
								
								<div class="col-md-2">
								
									<a href="?content=content/certification&li_class=Exams&select_exam_date=62">June. 2, <?php echo ($select_exam_date['year'] + 2);?></a>
								
								</div>
								
								<div class="col-md-2">
								
									<a href="?content=content/certification&li_class=Exams&select_exam_date=23">Feb. 4, <?php echo ($select_exam_date['year'] + 3);?></a>
